...
public class QuestGiver : MonoBehaviour
{
    ...
    public void ShowQuestPanel()
    {
        ...
        var questState = MainQuestManager.instance.GetQuestState("The Parched Land");

        if (questState == MainQuestManager.QuestState.Completed)
        {
            questDescriptionText.text = "Quest Completed: You found the hidden water source!";
        ...
        {
            questDescriptionText.text = "Find the hidden water beneath the cracked earth.";
    ...
    {
        MainQuestManager.instance.StartQuest("The Parched Land");
        questPanel.SetActive(false);
