...
// public class BearStatue : MonoBehaviour
// {
...
//         {
//             playerNearby = true;
//             Debug.Log("Press [E] to speak with ");
//             if (!isDialogueActive && !isDialogueCompleted)
//             {
...
//             questStatusText.text = "A Lost Cub";
...
//         else
//         {
//             questDescriptionText.text = "Reunite the cub with its mother. Go back here whne the quest is completed to receive a reward.";
//             questStatusText.text = "A Lost Cub";
...
//         Debug.Log("Quest Started: Reunite the cub with its mother. Go back here whne the quest is completed to receive a reward.");
//         questPanel.SetActive(false);
